        ...
        <div class="container topnav">
            ...
            <div class="collapse navbar-collapse"
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li><a href='<spring:url value="/"></spring:url>' style="color: white;"><%=home %></a></li>
                    <li><a href='<spring:url value="/about"></spring:url>' style="color: white;"><%=about %></a></li>
                    <li><a href='<spring:url value="/contact"></spring:url>' style="color: white;"><%=contact %></a></li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
        </div>
