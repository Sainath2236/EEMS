				...
				<div class="container">
					<div class="jumbotron">
						...
						<c:if test="${!empty status }">
							<center>
								<span>All ${status} Vouchers List</span><a
									href="<spring:url value="/${sessionScope.designation}/Manage Vouchers/${status}/List/VouchersList-${status}"></spring:url>">
									<button type="button" class="btn btn-primary btn-md">
										Download</button>
								</a>
							</center>
							...
							<tbody>
								<c:forEach items="${requestScope.vouchers}" var="vouchers">
									<tr>
										...
										<td><a
											href="<spring:url value="/${sessionScope.designation}/Manage Vouchers/${vouchers.voucherId}/downloadPDF"></spring:url>">
												<button type="button" class="btn btn-primary btn-md">
													Download</button>
										</a></td>
									</tr>
