...
public class VoucherExcelBuilder extends AbstractExcelView {

	@Override
	protected void buildExcelDocument(Map<String, Object> voucherMap,
			HSSFWorkbook workbook, HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		// get data model which is passed by the Spring container
        //List<Voucher> vouchers1 = (List<Voucher>) vouchers.get("vouchersList");
         Voucher voucher = (Voucher) voucherMap.get("voucher");
        // create a new Excel sheet
        HSSFSheet sheet = workbook.createSheet(""+voucher.getVoucherId());
